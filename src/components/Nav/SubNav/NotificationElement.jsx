...
export default function NotificationElement() {
  ...
  return (
    <div
      ...
      } mb-3 rounded bg-invert-color shadow-lg text-main-color font-bold cursor-pointer dark:text-gray-800 `}
      onClick={handleToggleView}
    >
      <div className="relative">
        <p className="w-full mb-5">Task receive</p>

        <p className={`w-full ${toggleView ? "opacity-100" : "opacity-0"}`}>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod autem
          repudiandae totam quis quasi quisquam iste id hic
        </p>
      </div>
    </div>
  );
